...
public class MainActivity extends AppCompatActivity
    ...
    public void onLocationChanged(Location location) {
        ...
        // If it's not null, get the latitude and longitude and get places
        if (location != null) {
            double lat = location.getLatitude();
            double lon = location.getLongitude();

            makePlacesRequest(lat, lon);
        }
    }

    // Sends a request to Google Places API
    private void makePlacesRequest(double lat, double lon) {
        ...
        String type = "restaurant";                                                 // Type of place
